    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "שגיאה בפרטי הכניסה.");
                    return View(model);
            }
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> CompanyLogin(LoginViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        /// <summary>
        /// Note: new method
        /// API get: /account/initialregister
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        [AllowAnonymous]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (isPreRegistered)
                {
                    ...
                    if (result.Succeeded)
                    {
                        WorkersBL.SetWorkerRegistered(model.IdNumber);
